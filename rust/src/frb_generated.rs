...
flutter_rust_bridge::frb_generated_boilerplate!(
                ...
                pub(crate) const FLUTTER_RUST_BRIDGE_CODEGEN_CONTENT_HASH: i32 = 1787305672;
...
fn wire__crate__api__encrypt_message_impl(port_: flutter_rust_bridge::for_generated::MessagePort,ptr_: flutter_rust_bridge::for_generated::PlatformGeneralizedUint8ListPtr,rust_vec_len_: i32,data_len_: i32)  {
                FLUTTER_RUST_BRIDGE_HANDLER.wrap_normal::<flutter_rust_bridge::for_generated::SseCodec,_,_>(flutter_rust_bridge::for_generated::TaskInfo{ debug_name: "encrypt_message", port: Some(port_), mode: flutter_rust_bridge::for_generated::FfiCallMode::Normal }, move || { 
            ...
            let api_message = <String>::sse_decode(&mut deserializer);deserializer.end(); move |context|  {
                    transform_result_sse::<_, ()>((move ||  {
                         let output_ok = Result::<_,()>::Ok(crate::api::encrypt_message(api_message))?;   Ok(output_ok)
                    })())
                } })
            }
...
// Section: dart2rust
        ...
        return ans_;}
                ...
                fn pde_ffi_dispatcher_primary_impl(
                    ...
                    match func_id {
                        1 => wire__crate__api__encrypt_message_impl(port, ptr, rust_vec_len, data_len),
                        _ => unreachable!(),
                    }
                }
